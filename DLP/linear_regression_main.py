...
from lib.LogisticRegression import *
...
def main(learning_rate=0.1, EPOCH=10, source='/Users/user/PycharmProjects/DeepLearningPy/static/uploaded/iris.data.csv'):
    ...
    if fit_type ==1:
        fit_name="ADAlineSGD"
        ppn = ADAlineSGD(learning_rate=0.1, EPOCH=20, random_state=1)
